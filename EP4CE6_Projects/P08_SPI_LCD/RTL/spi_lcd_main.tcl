...
# File: spi_lcd_main.tcl
# Generated on: Fri May 23 14:58:41 2025
...
if {[is_project_open]} {
	if {[string compare $quartus(project) "spi_lcd_main"]} {
		puts "Project spi_lcd_main is not open"
		set make_assignments 0
	}
} else {
	# Only open if not already open
	if {[project_exists spi_lcd_main]} {
		project_open -revision spi_lcd_main spi_lcd_main
	} else {
		project_new -revision spi_lcd_main spi_lcd_main
	}
