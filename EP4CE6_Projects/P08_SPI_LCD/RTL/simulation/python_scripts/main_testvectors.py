...
testcases_file        = open("../file/main/testcases.txt",'w')
expected_outputs_file = open("../file/main/expected_outputs.txt",'w')
status_reports_file   = open("../file/main/status_reports.txt",'w')
