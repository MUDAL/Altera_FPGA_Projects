...
# File: weather_sensor.tcl
# Generated on: Fri May 23 14:03:16 2025
...
if {[is_project_open]} {
	if {[string compare $quartus(project) "weather_sensor"]} {
		puts "Project weather_sensor is not open"
		set make_assignments 0
	}
} else {
	# Only open if not already open
	if {[project_exists weather_sensor]} {
		project_open -revision weather_sensor weather_sensor
	} else {
		project_new -revision weather_sensor weather_sensor
	}
...
if {$make_assignments} {
	...
	set_global_assignment -name PROJECT_CREATION_TIME_DATE "10:02:37  JANUARY 27, 2024"
	...
	set_global_assignment -name VHDL_FILE ../src/weather_sensor.vhd
	set_global_assignment -name VHDL_FILE ../src/lib/seg_rom.vhd
	set_global_assignment -name VHDL_FILE ../src/lib/seg_display.vhd
	set_global_assignment -name VHDL_FILE ../src/lib/one_wire.vhd
	...
	set_location_assignment PIN_115 -to io
