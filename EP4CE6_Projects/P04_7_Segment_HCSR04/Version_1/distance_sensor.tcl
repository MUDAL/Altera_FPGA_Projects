...
# File: distance_sensor.tcl
# Generated on: Fri May 23 14:37:24 2025
...
if {[is_project_open]} {
	if {[string compare $quartus(project) "distance_sensor"]} {
		puts "Project distance_sensor is not open"
		set make_assignments 0
	}
} else {
	# Only open if not already open
	if {[project_exists distance_sensor]} {
		project_open -revision distance_sensor distance_sensor
	} else {
		project_new -revision distance_sensor distance_sensor
	}
...
if {$make_assignments} {
	...
	set_global_assignment -name PROJECT_CREATION_TIME_DATE "12:51:37  FEBRUARY 04, 2024"
	...
	set_global_assignment -name VHDL_FILE ../src/distance_sensor.vhd
	set_global_assignment -name VHDL_FILE ../src/lib/seg_rom.vhd
	set_global_assignment -name VHDL_FILE ../src/lib/seg_display.vhd
	set_global_assignment -name VHDL_FILE ../src/lib/hcsr04.vhd
	set_global_assignment -name VHDL_FILE ../src/lib/dec_to_bcd.vhd
	set_location_assignment PIN_23 -to clk
	set_location_assignment PIN_127 -to dp
	set_location_assignment PIN_74 -to echo
	...
	set_location_assignment PIN_75 -to trig
	set_instance_assignment -name IO_STANDARD "3.3-V LVTTL" -to clk
	set_instance_assignment -name IO_STANDARD "3.3-V LVTTL" -to dp
	set_instance_assignment -name IO_STANDARD "3.3-V LVTTL" -to echo
