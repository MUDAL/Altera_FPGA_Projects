...
# File: lcd_main.tcl
# Generated on: Fri May 23 14:44:40 2025
...
if {[is_project_open]} {
	if {[string compare $quartus(project) "lcd_main"]} {
		puts "Project lcd_main is not open"
		set make_assignments 0
	}
} else {
	# Only open if not already open
	if {[project_exists lcd_main]} {
		project_open -revision lcd_main lcd_main
	} else {
		project_new -revision lcd_main lcd_main
	}
...
if {$make_assignments} {
	...
	set_global_assignment -name PROJECT_CREATION_TIME_DATE "18:18:29  FEBRUARY 16, 2024"
	...
	set_global_assignment -name VHDL_FILE ../src/lcd_main.vhd
	set_global_assignment -name VHDL_FILE ../src/lib/prog_mem.vhd
