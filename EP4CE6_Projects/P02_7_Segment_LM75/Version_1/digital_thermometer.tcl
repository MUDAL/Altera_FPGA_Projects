...
# File: digital_thermometer.tcl
# Generated on: Fri May 23 13:50:05 2025
...
if {[is_project_open]} {
	if {[string compare $quartus(project) "digital_thermometer"]} {
		puts "Project digital_thermometer is not open"
		set make_assignments 0
	}
} else {
	# Only open if not already open
	if {[project_exists digital_thermometer]} {
		project_open -revision digital_thermometer digital_thermometer
	} else {
		project_new -revision digital_thermometer digital_thermometer
	}
...
if {$make_assignments} {
	...
	set_global_assignment -name PROJECT_CREATION_TIME_DATE "13:02:34  FEBRUARY 08, 2024"
	...
	set_global_assignment -name VHDL_FILE ../src/digital_thermometer.vhd
	set_global_assignment -name VHDL_FILE ../src/lib/seg_rom.vhd
	set_global_assignment -name VHDL_FILE ../src/lib/seg_display.vhd
	set_global_assignment -name VHDL_FILE ../src/lib/i2c_reader.vhd
