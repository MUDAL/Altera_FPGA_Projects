...
testcases_file        = open("../file/spi/testcases.txt",'w')
expected_outputs_file = open("../file/spi/expected_outputs.txt",'w')
status_reports_file   = open("../file/spi/status_reports.txt",'w')
