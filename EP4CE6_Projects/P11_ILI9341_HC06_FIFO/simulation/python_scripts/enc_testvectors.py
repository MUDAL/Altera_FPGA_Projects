...
testcases_file        = open("../file/enc/testcases.txt",'w')
expected_outputs_file = open("../file/enc/expected_outputs.txt",'w')
status_reports_file   = open("../file/enc/status_reports.txt",'w')
