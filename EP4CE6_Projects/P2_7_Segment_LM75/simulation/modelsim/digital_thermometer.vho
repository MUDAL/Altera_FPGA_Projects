...
-- Equation(s):
-- \Equal0~7_combout\ = (clk_count(3) & (clk_count(2) & (clk_count(5) & clk_count(4))))
...
-- Equation(s):
-- \Equal0~5_combout\ = (clk_count(12) & (!clk_count(10) & (clk_count(11) & clk_count(13))))
...
-- Equation(s):
-- \Equal0~2_combout\ = (clk_count(20) & (clk_count(19) & (clk_count(18) & clk_count(21))))
...
-- Equation(s):
-- \Equal0~0_combout\ = (\display|count\(1) & (\display|count\(0) & (!clk_count(27) & !clk_count(26))))
...
-- Equation(s):
-- \Equal0~6_combout\ = (!clk_count(8) & (!clk_count(7) & (!clk_count(9) & !clk_count(6))))
...
-- Equation(s):
-- \lm75_i2c|Equal0~0_combout\ = (\lm75_i2c|clks\(8) & (\lm75_i2c|clks\(5) & (\lm75_i2c|clks\(6) & \lm75_i2c|clks\(4))))
...
-- Equation(s):
-- \lm75_i2c|Equal0~2_combout\ = (\display|count\(1) & (!\lm75_i2c|clks\(3) & (\lm75_i2c|Equal0~0_combout\ & \lm75_i2c|Equal0~1_combout\)))
...
-- Equation(s):
-- \lm75_i2c|Equal5~0_combout\ = (!\lm75_i2c|clks\(7) & (\lm75_i2c|clks\(2) & !\display|count\(0)))
...
-- Equation(s):
-- \lm75_i2c|Equal5~1_combout\ = (\display|count\(1) & (!\lm75_i2c|clks\(3) & (\lm75_i2c|Equal0~0_combout\ & \lm75_i2c|Equal5~0_combout\)))
...
PORT MAP (
	...
	datab => \lm75_i2c|index[4]~6_combout\,
...
-- Equation(s):
-- \lm75_i2c|index[4]~5_combout\ = (\lm75_i2c|index\(4) & (\lm75_i2c|index\(3) $ (((\lm75_i2c|index\(2)) # (\lm75_i2c|index\(1))))))
...
-- Equation(s):
-- \lm75_i2c|index[4]~12_combout\ = ((!\lm75_i2c|index\(1) & (!\lm75_i2c|index\(2) & !\lm75_i2c|index\(3)))) # (!\lm75_i2c|index\(4))
...
-- Equation(s):
-- \lm75_i2c|LessThan1~0_combout\ = (\lm75_i2c|clks\(6) & (\lm75_i2c|clks\(5) & (\lm75_i2c|clks\(3) & \lm75_i2c|clks\(4))))
...
-- Equation(s):
-- \lm75_i2c|Equal2~0_combout\ = (!\lm75_i2c|clks\(8) & (\lm75_i2c|clks\(2) & !\display|count\(1)))
...
-- Equation(s):
-- \lm75_i2c|Equal2~1_combout\ = (!\lm75_i2c|clks\(7) & (\lm75_i2c|LessThan1~0_combout\ & (\lm75_i2c|Equal2~0_combout\ & !\display|count\(0))))
...
-- Equation(s):
-- \lm75_i2c|index[4]~4_combout\ = (\lm75_i2c|index[4]~12_combout\ & ((\lm75_i2c|Equal2~1_combout\) # ((\lm75_i2c|Equal5~1_combout\ & \lm75_i2c|Equal4~1_combout\)))) # (!\lm75_i2c|index[4]~12_combout\ & (((\lm75_i2c|Equal5~1_combout\ & 
...
-- pragma translate_on
PORT MAP (
	dataa => \lm75_i2c|index[4]~12_combout\,
...
-- Equation(s):
-- \lm75_i2c|Equal4~0_combout\ = (\lm75_i2c|index\(1) & (!\lm75_i2c|index\(0) & (\lm75_i2c|index\(4) & \lm75_i2c|index\(3))))
...
-- Equation(s):
-- \lm75_i2c|i2c_buff[7]~3_combout\ = (!\lm75_i2c|index\(4) & (\lm75_i2c|index\(3) & (\lm75_i2c|state.ST_COMM~q\ & \lm75_i2c|Equal2~1_combout\)))
...
-- Equation(s):
-- \lm75_i2c|i2c_buff[7]~14_combout\ = (\lm75_i2c|index\(0) & (\lm75_i2c|index\(2) & (\lm75_i2c|index\(1) & \lm75_i2c|i2c_buff[7]~3_combout\)))
...
-- Equation(s):
-- \lm75_i2c|i2c_buff[2]~9_combout\ = (!\lm75_i2c|index\(0) & (!\lm75_i2c|index\(2) & (\lm75_i2c|index\(1) & \lm75_i2c|i2c_buff[7]~3_combout\)))
...
-- Equation(s):
-- \i2c_data_to_bcd|num_reg[6]~1_combout\ = (\i2c_data_to_bcd|state.ST_CALC~q\ & ((\i2c_data_to_bcd|LessThan3~1_combout\))) # (!\i2c_data_to_bcd|state.ST_CALC~q\ & (\lm75_i2c|i2c_buff\(2)))
...
-- Equation(s):
-- \i2c_data_to_bcd|num_reg[6]~2_combout\ = (\i2c_data_to_bcd|num_reg[6]~1_combout\ & ((\i2c_data_to_bcd|Add3~10_combout\) # ((!\i2c_data_to_bcd|state.ST_CALC~q\)))) # (!\i2c_data_to_bcd|num_reg[6]~1_combout\ & (((\i2c_data_to_bcd|state.ST_CALC~q\ & 
-- \i2c_data_to_bcd|Add1~11_combout\))))
...
-- Equation(s):
-- \i2c_data_to_bcd|num_reg[6]~3_combout\ = (\i2c_data_to_bcd|num_reg[4]~0_combout\ & ((\i2c_data_to_bcd|num_reg[6]~2_combout\) # ((\i2c_data_to_bcd|state.ST_DONE~q\ & \i2c_data_to_bcd|num_reg\(6))))) # (!\i2c_data_to_bcd|num_reg[4]~0_combout\ & 
...
-- pragma translate_on
PORT MAP (
	dataa => \i2c_data_to_bcd|num_reg[4]~0_combout\,
...
-- Equation(s):
-- \lm75_i2c|i2c_buff[6]~7_combout\ = (!\lm75_i2c|index\(0) & (\lm75_i2c|index\(2) & (\lm75_i2c|index\(1) & \lm75_i2c|i2c_buff[7]~3_combout\)))
...
-- Equation(s):
-- \i2c_data_to_bcd|num_reg[4]~0_combout\ = (!\i2c_data_to_bcd|state.ST_DONE~q\ & (((!\i2c_data_to_bcd|combinational_logic~1_combout\) # (!\i2c_data_to_bcd|state.ST_CALC~q\)) # (!\i2c_data_to_bcd|LessThan3~1_combout\)))
...
-- Equation(s):
-- \lm75_i2c|Equal3~1_combout\ = (!\lm75_i2c|index\(1) & (!\lm75_i2c|index\(2) & \lm75_i2c|index\(0)))
...
-- Equation(s):
-- \i2c_data_to_bcd|num_reg[7]~6_combout\ = (\i2c_data_to_bcd|num_reg[4]~0_combout\ & ((\i2c_data_to_bcd|num_reg[7]~5_combout\) # ((\i2c_data_to_bcd|state.ST_DONE~q\ & \i2c_data_to_bcd|num_reg\(7))))) # (!\i2c_data_to_bcd|num_reg[4]~0_combout\ & 
...
PORT MAP (
	...
	datab => \i2c_data_to_bcd|Selector0~2_combout\,
...
-- Equation(s):
-- \i2c_data_to_bcd|done_reg~2_combout\ = (\i2c_data_to_bcd|num_reg\(5) & (!\i2c_data_to_bcd|LessThan3~0_combout\)) # (!\i2c_data_to_bcd|num_reg\(5) & (((\i2c_data_to_bcd|combinational_logic~0_combout\ & !\i2c_data_to_bcd|num_reg\(4)))))
...
-- Equation(s):
-- \i2c_data_to_bcd|done_reg~3_combout\ = (\i2c_data_to_bcd|state.ST_CALC~q\ & (!\i2c_data_to_bcd|state.ST_DONE~q\ & (\i2c_data_to_bcd|done_reg~2_combout\ & \i2c_data_to_bcd|LessThan3~1_combout\)))
...
PORT MAP (
	dataa => \i2c_data_to_bcd|state.ST_CALC~q\,
	datab => \i2c_data_to_bcd|state.ST_DONE~q\,
	datac => \i2c_data_to_bcd|done_reg~2_combout\,
	datad => \i2c_data_to_bcd|LessThan3~1_combout\,
...
-- pragma translate_on
PORT MAP (
	dataa => \i2c_data_to_bcd|done_reg~3_combout\,
	datab => \lm75_i2c|done~q\,
...
-- Equation(s):
-- \lm75_i2c|Selector4~0_combout\ = (\lm75_i2c|state.ST_DONE~q\ & ((\lm75_i2c|Equal5~1_combout\) # ((\lm75_i2c|state.ST_STOP~q\ & !\lm75_i2c|Equal2~1_combout\)))) # (!\lm75_i2c|state.ST_DONE~q\ & (((\lm75_i2c|state.ST_STOP~q\ & 
...
-- Equation(s):
-- \lm75_i2c|state~14_combout\ = (\lm75_i2c|clks\(7) & (!\lm75_i2c|clks\(5) & (!\lm75_i2c|clks\(6) & \display|count\(0))))
...
-- Equation(s):
-- \lm75_i2c|Selector0~2_combout\ = (\lm75_i2c|state.ST_RESTART~q\ & (!\en~q\ & ((\lm75_i2c|state.ST_IDLE~q\) # (\lm75_i2c|state~15_combout\)))) # (!\lm75_i2c|state.ST_RESTART~q\ & (((\lm75_i2c|state.ST_IDLE~q\) # (\lm75_i2c|state~15_combout\))))
...
-- Equation(s):
-- \lm75_i2c|Selector2~0_combout\ = (\lm75_i2c|state.ST_START~q\ & ((\lm75_i2c|clks\(8)) # ((\lm75_i2c|LessThan1~1_combout\ & \lm75_i2c|LessThan1~0_combout\))))
...
-- Equation(s):
-- \lm75_i2c|Selector5~5_combout\ = (\lm75_i2c|Selector5~3_combout\) # ((\lm75_i2c|Selector2~0_combout\) # ((\lm75_i2c|Selector5~4_combout\) # (\lm75_i2c|Selector1~0_combout\)))
...
-- pragma translate_on
PORT MAP (
	dataa => \lm75_i2c|Selector5~3_combout\,
...
PORT MAP (
	dataa => \en~q\,
	datab => \lm75_i2c|Selector5~4_combout\,
...
-- Equation(s):
-- \lm75_i2c|Equal3~0_combout\ = (!\lm75_i2c|index\(2) & !\lm75_i2c|index\(1))
...
-- Equation(s):
-- \lm75_i2c|Equal3~2_combout\ = (\lm75_i2c|index\(4) & (\lm75_i2c|index\(0) & (\lm75_i2c|Equal3~0_combout\ & !\lm75_i2c|index\(3))))
...
-- Equation(s):
-- \lm75_i2c|Selector9~1_combout\ = (\lm75_i2c|Equal5~1_combout\ & (!\lm75_i2c|Equal4~1_combout\ & ((\lm75_i2c|Selector9~0_combout\) # (\lm75_i2c|Equal3~2_combout\)))) # (!\lm75_i2c|Equal5~1_combout\ & (\lm75_i2c|Selector9~0_combout\))
...
-- Equation(s):
-- \display|Equal0~3_combout\ = (\display|count\(2) & (!\display|count\(4) & (!\display|count\(5) & \display|count\(3))))
...
-- Equation(s):
-- \lm75_i2c|i2c_buff[8]~0_combout\ = (\lm75_i2c|index\(4) & (!\lm75_i2c|index\(3) & (!\lm75_i2c|index\(2) & !\lm75_i2c|index\(0))))
...
PORT MAP (
	...
	datad => \i2c_data_to_bcd|bcd_reg\(9),
...
-- Equation(s):
-- \i2c_data_to_bcd|Selector7~1_combout\ = (\i2c_data_to_bcd|tens_reg\(3) & ((\i2c_data_to_bcd|state.ST_DONE~q\) # ((!\i2c_data_to_bcd|Selector7~0_combout\ & \i2c_data_to_bcd|state.ST_CALC~q\)))) # (!\i2c_data_to_bcd|tens_reg\(3) & 
-- (\i2c_data_to_bcd|Selector7~0_combout\ & ((\i2c_data_to_bcd|state.ST_CALC~q\))))
...
-- pragma translate_on
PORT MAP (
	dataa => \i2c_data_to_bcd|Selector7~0_combout\,
	datab => \i2c_data_to_bcd|state.ST_DONE~q\,
...
-- Equation(s):
-- \i2c_data_to_bcd|Selector3~0_combout\ = (\i2c_data_to_bcd|hundreds_reg\(2) & (\i2c_data_to_bcd|hundreds_reg\(0) & (\i2c_data_to_bcd|hundreds_reg\(1) & !\i2c_data_to_bcd|LessThan3~1_combout\)))
...
PORT MAP (
	...
	datad => \i2c_data_to_bcd|bcd_reg\(11),
...
-- Equation(s):
-- \display|rom|rom~0_combout\ = (!\display|Mux3~1_combout\ & (!\display|Mux1~1_combout\ & (\display|Mux4~1_combout\ $ (\display|Mux2~1_combout\))))
...
-- Equation(s):
-- \display|rom|rom~2_combout\ = (!\display|Mux4~1_combout\ & (!\display|Mux2~1_combout\ & (\display|Mux3~1_combout\ & !\display|Mux1~1_combout\)))
...
-- Equation(s):
-- \display|rom|rom~3_combout\ = (!\display|Mux1~1_combout\ & ((\display|Mux4~1_combout\ & (\display|Mux2~1_combout\ $ (!\display|Mux3~1_combout\))) # (!\display|Mux4~1_combout\ & (\display|Mux2~1_combout\ & !\display|Mux3~1_combout\))))
